...
// sha256: 95975761d189289b6c7524f7c0d4f49bf3e2118b5b349b15395e1510238d4830
use std::str::FromStr;
use ast::{Ast};
...
mod __parse__Expr {
    ...
    {
        // AndExpr = AndExpr, "AND", Termo => ActionFn(3);
    ...
    {
        // Expr = Expr, "OR", AndExpr => ActionFn(1);
        let __sym2 = __pop_Variant1(__symbols);
        let __sym1 = __pop_Variant0(__symbols);
        let __sym0 = __pop_Variant1(__symbols);
        let __start = __sym0.0.clone();
    ...
    {
        // Termo = Term, Term, Term => ActionFn(7);
    ...
    {
        // Termo = Term, Term, Term, Term => ActionFn(8);
    ...
    {
        // Termo = Term, Term, Term, Term, Term => ActionFn(9);
    ...
    {
        // Termo = Term, Term, Term, Term, Term, Term => ActionFn(10);
...
{
    Box::new(Ast::Filter(format!("{} {}", __0, __1)))
}
...
{
    Box::new(Ast::Filter(format!("{} {} {}", __0, __1, __2)))
}
...
{
    Box::new(Ast::Filter(format!("{} {} {} {}", __0, __1, __2, __3)))
}
...
{
    Box::new(Ast::Filter(format!("{} {} {} {} {}", __0, __1, __2, __3, __4)))
}
...
{
    Box::new(Ast::Filter(format!("{} {} {} {} {} {}", __0, __1, __2, __3, __4, __5)))
}
